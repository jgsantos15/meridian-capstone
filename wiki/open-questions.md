...
- [ ] **Does Meridian consider Gelson's a direct competitor, or a different kind of player?**
  Gelson's is the closest scale/geography comparable in Southern California (27 stores vs. Meridian's 14), but the brief never mentions competitors by name. → [Grocery Industry Context](concepts/grocery-industry-context.md)
